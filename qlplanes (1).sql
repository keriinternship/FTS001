...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 30, 2020 at 04:00 AM
...
INSERT INTO `airticket` (`id`, `diemdi`, `diemden`, `gioxp`, `gioden`, `giatien`, `ngaydi`, `ngayden`, `company_id`, `planes_id`, `cate_id`, `customer_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_main` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gioitinh` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hanhli_id` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `customer` (`customer_id`, `name`, `name_main`, `gioitinh`, `phone`, `hanhli_id`, `email`) VALUES
(1, 'Phạm Thái Dương', '', 'Nam', '0585298286', '1', 'ptduong@keri.vn'),
(2, 'Nguyễn Văn Hảo', '', 'Nam', '123465789', '2', 'nvhao@keri.vn');

-- --------------------------------------------------------

--
-- Table structure for table `hanhli`
--

DROP TABLE IF EXISTS `hanhli`;
CREATE TABLE IF NOT EXISTS `hanhli` (
  `hanhli_id` int(11) NOT NULL,
  `loai` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`hanhli_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `hanhli`
--

INSERT INTO `hanhli` (`hanhli_id`, `loai`) VALUES
(1, 'Không mang theo hành lý'),
(2, 'Hành lý mang theo 7kg'),
(3, 'Dưới 15kg hành lý 220,000VND'),
(4, 'Dưới 20kg hành lý 250,000VND'),
(5, 'Dưới 25kg hành lý 350,000VND'),
(6, 'Dưới 30kg hành lý 450,000VND'),
(7, 'Dưới 35kg hành lý 480,000VND'),
(8, 'Dưới 40kg hành lý 620,000VND');
...
(1, 'thaiduong', '123456', 'Phạm Thái Dương'),
