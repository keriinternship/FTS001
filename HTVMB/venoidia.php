...
$scss = new Compiler();
$sass = file_get_contents("sass/venoidia.scss");
$style = $scss->compile($sass);
file_put_contents("css/venoidia.css",$style);
...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo $url_path ?>/css/venoidia">
