...
$url_path = str_replace('\\', '/', $url_path);
    ...
    // sass->css xacnhan dat ve
    $styles1 = $scss->compile('@import "XacNhan.scss";');

    $css1 = fopen('css/XacNhan.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/XacNhan.css" rel="stylesheet" type="text/css" />    
